...
class General:
    ...
    async def rps(self, ctx, your_choice : RPSParser):
        ...
        sentinel_choice = choice((RPS.rock, RPS.paper, RPS.scissors))
        cond = {
        ...
        if sentinel_choice == player_choice:
            outcome = None # Tie
        else:
            outcome = cond[(player_choice, sentinel_choice)]

        if outcome is True:
            await self.bot.say("{} You win {}!"
                               "".format(sentinel_choice.value, author.mention))
